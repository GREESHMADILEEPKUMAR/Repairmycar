...
public class Notificationtesting 
{
    ...
    //private Requestaquote  requestquote;
    private WebDriverWait wait;

    @BeforeTest
    public void setup() {
        // Set the path to the chromedriver executable. Adjust this path according to your environment.
    	driver = new ChromeDriver();
        new WebDriverWait(driver, Duration.ofSeconds(20));
        loginHelper = new CustomerLoginHelper(driver);
        //requestquote=new Requestaquote (driver);
...
public void registrationcopyimage()
{
    ...
    @Test(priority=3)
    public boolean verifyNotificationMessage(String expectedMessage) 
    {
        By notificationLocator = By.xpath("//div[@class='notification-message' and contains(Your quote request (Job ID #12345) has been submitted.(), '" + expectedMessage + "')]");
        WebElement notificationElement = wait.until(ExpectedConditions.visibilityOfElementLocated(notificationLocator));
